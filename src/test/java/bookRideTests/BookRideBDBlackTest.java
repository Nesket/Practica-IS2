...
public class BookRideBDBlackTest {
 ...
 // additional operations needed to execute the test
	...
	/*
	 * @Test public void test1() { // everything correct, should return true
	 ...
	 * 
	 * boolean result = sut.bookRide(username, ride, 1, 0); sut.close();
	 * 
	 ...
	 * }
	 * 
	 * @Test public void test2() { // username equals null, should return false
	 * System.out.println("\n----- TEST 2 -----"); try {
	 * 
	 * 
	 ...
	 * 
	 * @Test public void test3() { // ride equals null, should return false
	 * System.out.println("\n----- TEST 3 -----");
	 * 
	 * try{
	 * 
	 ...
	 * 
	 * // Prepare existing user String fakePassword = "fakepassword"; testDA.open();
	 * if (testDA.existTraveler(username)) { testDA.removeTraveler(username); }
	 * 
	 * traveler = testDA.createTraveler(username, fakePassword); testDA.close();
	 * 
	 * // Invoke System Under Test sut.open();
	 * 
	 * boolean result = sut.bookRide(username, null, seats, desk); sut.close();
	 * 
	 * // Check results assertFalse(result);
	 * 
	 * } catch(Exception e){ logger.info("Error encountered: "+e.getMessage()); }
	 * finally { // Clean up: remove the created test data testDA.open();
	 * testDA.removeTraveler(username); testDA.close(); }
	 * 
	 * }
	 * 
	 * @Test public void test4() { // seats equals -1, should return false
	 * System.out.println("\n----- TEST 4 -----"); try { // Prepare parameters
	 * setInitValues("user1", ride, -1, 0); // Prepare existing user String
	 * fakePassword = "fakepassword"; testDA.open(); if
	 * (testDA.existTraveler(username)) { testDA.removeTraveler(username); }
	 * 
	 ...
	 * }
	 * 
	 * @Test public void test5() { // discount equals 101, should return false
	 * System.out.println("\n----- TEST 5 -----"); try { // Prepare parameters
	 * setInitValues("user1", ride, 1, 101); // Prepare existing user String
	 * fakePassword = "fakepassword"; testDA.open(); if
	 * (testDA.existTraveler(username)) { testDA.removeTraveler(username); }
	 * 
	 * traveler = testDA.createTraveler(username, fakePassword);
	 ...
	 * }
	 * 
	 * @Test public void test6() { // not enough seats available, should return
	 * false System.out.println("\n----- TEST 6 -----"); try { // Prepare parameters
	 * setInitValues("user1", ride, 1, 0); // Prepare existing user String
	 * fakePassword = "fakepassword"; testDA.open(); if
	 * (testDA.existTraveler(username)) { testDA.removeTraveler(username); }
	 * 
	 ...
	 * 
	 * 
	 * try { rideDate = sdf.parse("10/10/2026"); } catch (ParseException e) {
	 * logger.info("Error encountered: "+e.getMessage()); }
	 * 
	 * if (testDA.existDriver(driverUsername)) {
	 * testDA.removeDriver(driverUsername); } driver =
	 * testDA.createDriver(driverUsername, fakePassword);
	 * 
	 * int nPlaces = 0; float price = 10; ride =
	 * testDA.addRideToDriver(driverUsername, rideFrom, rideTo, rideDate, nPlaces,
	 * price); testDA.existRide(driverUsername, rideFrom, rideTo, rideDate);
	 * testDA.close();
	 * 
	 ...
	 * }
	 * 
	 * @Test public void test7() { // user is not in the DB, should return false
	 * System.out.println("\n----- TEST 7 -----"); try { // Prepare parameters
